...
<div class="row">
  ...
  <div class="col-xl-10 col-lg-10">
    <div class="card shadow mb-4">
      ...
      <!-- Card Body -->
      <div class="card-body">
    <form action="/postsetoranIn" method="POST">
    @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="jumlah_setoran" value="{{   old('jumlah_setoran') }}"  placeholder="Masukkan Nama" class="form-control @error('jumlah_setoran') is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp">
