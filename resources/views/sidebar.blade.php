...
<br>
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route ('dashboard')}}">
        ...
        <div class="sidebar-brand-text mx-3">JagaBes (Sumenep) <sup>Babbalan</sup></div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#tongsampah" aria-expanded="true" aria-controls="collapsePages">
        <i class="fas fa-trash-alt"></i>
          <span> Tong Sampah</span>
        </a>
        <div id="tongsampah" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Data Terhapus:</h6>
            <a class="collapse-item" href="login.html">Data Santunan</a>
            <a class="collapse-item" href="login.html">Data Anak yatim</a>
            <a class="collapse-item" href="login.html">Data Anggota</a>
